...
export const PROCESS_STEPS: ProcessStep[] = [
  ...
  },
  {
    ...
    duration: "Le jour J",
    description:
      "Je publie sur votre nom de domaine, configure l'hébergement et active vos emails pro. Votre site est soumis à Google dès le premier jour. Les modifications via WhatsApp sont incluses : vous me contactez, je corrige.",
  },
]
